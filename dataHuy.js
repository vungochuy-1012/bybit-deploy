const dataHuy1 = [
    {
        apiKey: 'SaZ7cqT05eCMTabNS5',
        secretKey: 'y80CDn5E04rDIHUU106vfP7y6TncQFXjAhJT',
        proxy: {
    ...
    {
        apiKey: 'Cxcew2Xdx7rwqX0f3b',
        secretKey: 'BXPgPxOIMgF8rYDzyzfDLJawUdhB9MBKAlh3',
        proxy: {
            host: "qna03.vitechcheap.com",
            port: 28052,
            auth: { username: "user_gnkogl", password: "hbwy0u7t" },
    ...
    {
        apiKey: 'W32HHanwPIld4CLgBs',
        secretKey: 'Mg5HKMCtjjP89jz3xrFoKTKdCSjzp3oJVuA7',
        proxy: {
            host: "qna03.vitechcheap.com",
            port: 28074,
            auth: { username: "user_gnkogl", password: "hbwy0u7t" },
...
const dataHuy2 = [
    { apiKey: 'oXdBcSLBLbSJWZ4o2T', secretKey: 'btakQB4KnZL8hPek73L1wD99ohskUVumCbRW' },
    // { apiKey: 'xvI7ZIAFbMZiZjjgG7', secretKey: 'yApuT9dOnx7e2bj1XusoWrkHtJ2e7r2sGPLU' },
    // { apiKey: '51REqXomETz79hq1pD', secretKey: 'vFqN7Esp3GuW77nDuhpSWzq22seoMClB8Ljr' },
    { apiKey: 'ub2KFS2CEgqQkzwAXv', secretKey: '16TkpUInDqXiRqNlPF1sodUhiXuIqHd6NkQ4' },
    { apiKey: 'GfmOZtY8tTCf36nmC6', secretKey: 'pygenAHtTQcK0Elgu04nEB75oMfvsRPMJy1H' },
    { apiKey: 'KBRRZ4i4e6mXkvQBze', secretKey: 'trXOtzGDZZ5JCf7kZN08GZxDxujhBLUa7MDk' },
    { apiKey: 'wocJSGg2BDigsShlhA', secretKey: 'jYzH4kiwu9at2IKaTeLOVuEphSID3DNG8U8R' },
    { apiKey: 'RADbCjkxxhqvMtK4Ud', secretKey: '9f1VSmbByTATDXFoAbR4lPRSvBuTYhMnzDqU' },
    { apiKey: 'DjWUEJii55b3rDF9EV', secretKey: 'TEgYJLtmfkPVh91HmK3QmYpEaguuOHYlrnvD' },
    { apiKey: 'mPZPIJAOBtsuOYSv04', secretKey: 'jrpVnTcK2I8xHqyCW8qCkTTHvXdw9THk6vGW' }
];
...
// ];
module.exports = { dataHuy1, dataHuy2, dataHuy3 };